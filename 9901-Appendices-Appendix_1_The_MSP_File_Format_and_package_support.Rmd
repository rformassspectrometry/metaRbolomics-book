```{r setip_app1, warning=FALSE, echo=FALSE, message=FALSE}
source("funs.R")
...
a1 <- readLines("data/supp_L1S2.txt", encoding = "ANSI")
b1 <- readLines("data/supp_L1S3.txt", encoding = "ANSI")
...
if (format %in% c("pdf", "latex")) {
    ...
    kable(LS23, format = "latex", booktabs = TRUE, escape = FALSE, col.names = NULL) %>% 
        column_spec(1, width = "24em", border_right = TRUE) %>% 
