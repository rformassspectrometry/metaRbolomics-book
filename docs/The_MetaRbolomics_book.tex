...
Derives stable estimates of the metabolome-wide significance level within a univariate approach based on a permutation procedure which effectively controls the maximum overall type I error rate at the a level. & \href{https://github.com/AlinaPeluso/MWSL}{MWSL} & GitHub\\
\rowcolor{gray!6}  \addlinespace[0.3em]
...
From the total, 65 packages had at least one
